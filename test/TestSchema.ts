...
schema.addTable('table1',
  {
    ...
    instanceToRow: (object1: Object1, row: any) => {
      ...
      row['column3'] = object1.property3 != null ? new Date(object1.property3).setFullYear(object1.property3.getFullYear() + 1) : object1.property3
    ...
    rowToInstance: (row: any, object1: Object1) => {
      ...
      object1.property3 = row['column3'] != null ? new Date(row['column3']).setFullYear(row['column3'].getFullYear() - 1) : row['column3']
...
schema.addTable('table2', {
  ...
  instanceToRow: (object2: Object2, row: any) => {
    ...
    row['column3'] = object2.property3 != null ? new Date(object2.property3).setFullYear(object2.property3.getFullYear() + 1) : object2.property3
  ...
  rowToInstance: (row: any, object2: Object2) => {
    ...
    object2.property3 = row['column3'] != null ? new Date(row['column3']).setFullYear(row['column3'].getFullYear() - 1) : row['column3']
...
schema.addTable('many_to_many_table1', {
  ...
  instanceToRow: (manyToMany: ManyToManyObject1, row: any) => {
    ...
    row['column3'] = manyToMany.property3 != null ? new Date(manyToMany.property3).setFullYear(manyToMany.property3.getFullYear() + 1) : manyToMany.property3
  },
  rowToInstance: (row: any, manyToMany: ManyToManyObject1) => {
    ...
    manyToMany.property3 = row['column3'] != null ? new Date(row['column3']).setFullYear(row['column3'].getFullYear() - 1) : row['column3']
  }
})
