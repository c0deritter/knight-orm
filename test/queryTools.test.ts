...
describe('queryTools', function() {
  describe('buildSelectQuery', function() {
    ...
    it('should handle inter table relationships', function() {
      ...
      expect(query._selects.length).to.equal(9)
      ...
      expect(query._selects[6]).to.equal('table1__many.table1_id2 table1__many__table1_id2')
      expect(query._selects[7]).to.equal('table1__many__object2.id table1__many__object2__id')
      expect(query._selects[8]).to.equal('table1__many__object2.column1 table1__many__object2__column1')
